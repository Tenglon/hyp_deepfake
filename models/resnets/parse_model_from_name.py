...
from .hyperbolicDeepfake import HyperbolicResNetDeepfake

# <channel_size1>-<channel_size2>-<channel_size3>-resnet-<depth>
######HyperbolicResNet######
# <channel_size1>  is conv's out_channels=channel_dims[0],
...
def parse_model_from_name(
    ...
    elif model_type == "hyperbolicDeepfake":
        model_class = HyperbolicResNet
