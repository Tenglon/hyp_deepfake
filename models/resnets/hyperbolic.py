...
from ..nn import PoincareBatchNorm2d, PoincareConvolution2d, PoincareLinear,PoincareBatchNorm
...
class HyperbolicResNet(nn.Module):
    ...
    def __init__(
        ...
        self.bn0 = PoincareBatchNorm(
            1024, ball=self.bn_ball, use_midpoint=self.bn_midpoint
        )
        ...
        self.fc0 = PoincareLinear(
            in_features=channel_dims[2],
            out_features=1024,
            ball=self.linear_ball,
        )

        self.fc1 = PoincareLinear(
            in_features=1024,
            out_features=1024,
            ball=self.linear_ball,
        )

        self.fc2 = PoincareLinear(
            in_features=1024,
